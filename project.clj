(defproject bootcamp-luminus "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot bootcamp-luminus.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [bootcamp-luminus.app]}}
     :devtools
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "bootcamp-luminus.jar"
